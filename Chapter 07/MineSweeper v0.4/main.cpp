...
const char *MainClassName = "RedContritio Test MS v0.3 Practice";
const char *MainTitleName = "MineSweeper v0.3";
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch ( msg )
	{
		...
		case WM_RBUTTONDOWN:
		{
			if ( pController ) pController->SaveElites();
			break;
		}
		case WM_KEYUP:
		{
			...
			switch ( wParam )
			{
				...
				{
					if ( pController ) pController->adjustSetting(wParam);
				}
				case VK_RETURN:
				{
					break;
