...
{
	m_NumInputs	          =	CParam::NumOfInput ;
	m_NumOutputs		      =	CParam::NumOfOutput ;
	m_NumHiddenLayers	    =	CParam::NumOfHidden ;
	m_NeuronsPerHiddenLyr =	CParam::NeuronsPerHiddenLayer;
